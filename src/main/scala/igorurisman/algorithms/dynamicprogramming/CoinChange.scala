...
object CoinChange extends App {
  ...
  val change = 250
  val coins = Array(41, 34, 46, 9, 37, 32, 42, 21, 7, 13, 1, 24, 3, 43, 2, 23, 8, 45, 19, 30, 29, 18, 35, 11)
//  val change = 10
//  val coins = Array(1, 2, 5)
  println(ways(change, coins))


  /**
   *   Compute number of ways change can be given in coins of given denominations.
   *   Key idea is to consider the table with as many rows as the number of coins
